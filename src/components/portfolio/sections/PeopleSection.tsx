...
function MemberRow({ member, badge }: { member: PortfolioMember; badge?: string }) {
  ...
  const showImage = Boolean(member.avatar) && !imageFailed;
      ...
      <div className="flex items-center gap-0.5 shrink-0">
        {member.email && (
          <a
            ...
            className="inline-flex items-center justify-center h-11 w-11 text-forest/40 hover:text-terracotta transition-colors"
          >
